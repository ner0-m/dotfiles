...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'surround.nvim', 'targets.vim', 'nvim-treesitter', 'vim-illuminate', 'Comment.nvim', 'format.nvim', 'gitsigns.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
