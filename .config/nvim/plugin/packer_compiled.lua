...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'Comment.nvim', 'vim-illuminate', 'neoscroll.nvim', 'format.nvim', 'gitsigns.nvim', 'surround.nvim', 'targets.vim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
