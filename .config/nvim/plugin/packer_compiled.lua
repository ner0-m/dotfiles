...
_G.packer_plugins = {
  ...
  LuaSnip = {
    ...
    url = "/home/david/src/nvim_plugins/LuaSnip"
  },
  ["barbar.nvim"] = {
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-illuminate', 'format.nvim', 'gitsigns.nvim', 'neoscroll.nvim', 'surround.nvim', 'targets.vim', 'Comment.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
