...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'format.nvim', 'surround.nvim', 'Comment.nvim', 'nvim-treesitter', 'vim-illuminate', 'neoscroll.nvim', 'targets.vim', 'gitsigns.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
